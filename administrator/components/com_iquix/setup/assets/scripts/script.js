	...
	installation: {
		...
		download: function() {
			qx.installation.ajaxCall('download', {}, function(result){
				// Set the progress
				qx.installation.update( 'data-progress-download' , result , '40%');
		...
		cleanCache: function() {
			...
			qx.installation.ajaxCall('cleanCache', {}, function(result) {
				...
				qx.installation.update('data-progress-cleancache', result, '45%');
				if (!result.state) {
		...
		backupDatabase: function() {
			...
			qx.installation.ajaxCall('backupDatabase' , {} , function(result) {
				// Set the progress
				qx.installation.update( 'data-progress-backup' , result , '50%');
		...
		installComponent : function() {
			...
			{
				// Set the progress
				qx.installation.update( 'data-progress-component' , result , '60%');
		...
		installLibrary : function() {
			...
			{
				// Set the progress
				qx.installation.update( 'data-progress-library' , result , '70%');
		...
		installModules: function() {
			...
			qx.installation.ajaxCall('installModules', {}, function(result) {
				// Set the progress
				qx.installation.update('data-progress-modules', result , '80%');
