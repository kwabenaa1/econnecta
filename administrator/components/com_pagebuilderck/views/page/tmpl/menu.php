...
?>
<style type="text/css">
<?php if ($this->input->get('iscontenttype', 0, 'int') !== 1) { ?>
body {
	margin-left: 310px;
}
<?php } ?>
...
?>
<?php 
if ($this->input->get('iscontenttype', 0, 'int') !== 1) { ?>
<div id="menuck" class="menuck clearfix ckinterface">
	<div class="menuckpanels">
		...
		<?php if ($this->input->get('tckedition', 0, 'int') == 0) { ?>
...
//		$items = Pagebuilderck\CKFof::triggerEvent( 'onPagebuilderckAddItemToMenu' );
	...
	<div class="menuckbootomtoolbar">
		<?php if ($this->input->get('id', 0, 'int') 
				&& $this->input->get('option', '', 'cmd') == 'com_pagebuilderck' 
				&& $this->input->get('view', '', 'cmd') == 'page' 
				&& \Pagebuilderck\CKFof::isAdmin()){ ?>
		<a class="" target="_blank" href="<?php echo JUri::root(true) ?>/index.php?option=com_pagebuilderck&view=page&id=<?php echo $this->input->get('id', '', 'int') ?>"><span class="menuckbootomtoolbar-button cktip" title="<?php echo JText::_('CK_PREVIEW_FRONT') ?>"><span class="fa fa-eye"></span><span></a>
		<?php } else if ($this->input->get('id', 0, 'int') && $this->input->get('option', '', 'cmd') == 'com_content' && $this->input->get('view', '', 'cmd') == 'article' && \Pagebuilderck\CKFof::isAdmin()) { ?>
		<a class="" target="_blank" href="<?php echo JUri::root(true) ?>/index.php?option=com_content&view=article&id=<?php echo $this->input->get('id', '', 'int') ?>"><span class="menuckbootomtoolbar-button cktip" title="<?php echo JText::_('CK_PREVIEW_FRONT') ?>"><span class="fa fa-eye"></span><span></a>
		<?php }?>
		<?php if ( 
				($this->input->get('option', '', 'cmd') == 'com_content' && $this->input->get('view', '', 'cmd') == 'article' && \Pagebuilderck\CKFof::isAdmin())
			|| ($this->input->get('option', '', 'cmd') == 'com_flexicontent' && $this->input->get('view', '', 'cmd') == 'article' && \Pagebuilderck\CKFof::isAdmin())
			|| ($this->input->get('option', '', 'cmd') == 'com_modules' && $this->input->get('view', '', 'cmd') == 'module' && \Pagebuilderck\CKFof::isAdmin())
			|| ($this->input->get('option', '', 'cmd') == 'com_advmodulesmanager' && $this->input->get('view', '', 'cmd') == 'module' && \Pagebuilderck\CKFof::isAdmin())
				) { ?>
